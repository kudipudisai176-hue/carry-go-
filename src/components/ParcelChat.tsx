...
export default function ParcelChat({ deliveryId, currentUserId, showHeader = true, className = "" }: { deliveryId: string, currentUserId: string, showHeader?: boolean, className?: string }) {
  ...
  useEffect(() => {
    ...
    // Use polling for real-time updates since we moved from Supabase to custom backend
